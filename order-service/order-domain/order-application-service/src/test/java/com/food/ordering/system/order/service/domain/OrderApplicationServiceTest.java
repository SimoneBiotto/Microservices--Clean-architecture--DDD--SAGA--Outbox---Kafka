...
@TestInstance(TestInstance.Lifecycle.PER_CLASS) // ci permette di usare @BeforeAll e @AfterAll non statici
...
public class OrderApplicationServiceTest {
    ...
    public void testCreateOrderWithWrongTotalPrice() {
        ...
        assertEquals("Total price (250.00) is not equal to the sum of the items (200.00)",orderDomainException.getMessage());
    }
    ...
    public void testCreateOrderWithWrongProductPrice() {
        ...
        assertEquals("Order item price (60.00 is not valid for product product-2", orderDomainException.getMessage());
    }
